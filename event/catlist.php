                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-12">
                                <div class="right-side">
                                    <div class="toolbar">
                                        <div class="finde-count"><?php echo $paginate->Totalno("SELECT * FROM event WHERE type =:category AND end >= NOW() AND end <= NOW() + INTERVAL 30 DAY",rawurldecode(clear($_GET['type']))); ?>   event found.  </div>
                                    ...
                                    $query = "SELECT * FROM event WHERE type = :category AND end >= NOW() AND end <= NOW() + INTERVAL 30 DAY ORDER BY `event_id` DESC ";
                                    $newquery = $paginate->paging($query, $records_per_page);
                                    $data = $paginate->dataview($newquery,clear($_GET['type']));
                                    ?>

                                    <div class="pagination">
                                        <ul>

                                        <?php $paginate->paginglink($query, $records_per_page,clear($_GET['type'])); ?>
                                        </ul>
