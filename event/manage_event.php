    ...
    <section class="current-openning">
        <div class="container">
            <div class="heading">
                ...
                <div class="info-text">All the information you will need is listed below, just click on the event you want to know more about and that's it.</div>
            </div>
            <div class="openings-info">
                <div class="row">

                    <div class="col-sm-9 col-sm-offset-2">
                        <div class="openings-title">All Events</div>
                        <div class="job-view">
                            <div class="job-viewBox">
                                <?php
                                $getEventByOrganizer = $user->getEventByOrganizer($getorganizername['name']);
                                ...
                                foreach ($getEventByOrganizer as $getEvent) {
                                    ...
                                    <div class="openings-slide">
                                        ...
                                        <a class="btn" href="view_event?event_title=<?php echo rawurlencode($slug); ?>">Know More</a>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
